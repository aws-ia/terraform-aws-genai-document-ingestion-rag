...
#   name        = "${var.solution_prefix}-${var.open_search_props.collection_name}"
#   type        = "encryption"
#   description = "encryption policy for ${var.solution_prefix}-${var.open_search_props.collection_name}"
#   policy = jsonencode({
#     Rules = [
#       {
#         Resource = [
